...
class Constructor():
    ...
    def construct(self):
        ...
        for i in range(self.nr_nodes):
            ...
            self.network.createSynapse(start_node, graph_node, w=-self.nr_nodes, d=1)
            self.network.createSynapse(start_node, graph_node, w=self.nr_nodes-1, d=2)
            ...
            self.network.createSynapse(start_node, part_of_mst_node, w=1, d=1)
            self.network.createSynapse(part_of_mst_node, and_gate_part_of_mst_node, w=1, d=1)
            self.network.createSynapse(start_node, and_gate_part_of_mst_node, w=1, d=2)
